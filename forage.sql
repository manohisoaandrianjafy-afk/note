...
CREATE TABLE t_demande (
    ...
    CONSTRAINT fk_demande_client FOREIGN KEY (id_client) REFERENCES t_client (id) ON DELETE CASCADE
);
...
CREATE TABLE t_demande_status (
    ...
    CONSTRAINT fk_ds_demande FOREIGN KEY (id_demande) REFERENCES t_demande (id) ON DELETE CASCADE,
    CONSTRAINT fk_ds_status FOREIGN KEY (id_status) REFERENCES t_status (id)
);
...
INSERT INTO t_typedevis (libelle) VALUES ('Etude'), ('Forage');
...
CREATE TABLE t_devis (
    ...
    CONSTRAINT fk_devis_type FOREIGN KEY (id_type) REFERENCES t_typedevis (id),
    CONSTRAINT fk_devis_demande FOREIGN KEY (id_demande) REFERENCES t_demande (id) ON DELETE CASCADE
);
