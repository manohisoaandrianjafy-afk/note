...
<body>
    ...
    <a href="/matiere/new" class="add-btn">Ajouter</a>
    ...
    <table>
        ...
        <tr>
            ...
            <td>${m.nom}</td>
            <td>
                <a href="/matiere/edit/${m.id}" class="action-link edit">Modifier</a>
                <a href="/matiere/delete/${m.id}" class="action-link delete">Supprimer</a>
            </td>
        </tr>
        </c:forEach>
    </table>
